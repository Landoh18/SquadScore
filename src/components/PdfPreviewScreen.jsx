...
// wired to generatePdf. The Run it back button (V1.1) starts a fresh round
// with the same scorer + same shooters in same starting-post order.
...
export default function PdfPreviewScreen({ round, rosterById, onRunItBack }) {
  ...
  const handleRunItBack = () => {
    if (onRunItBack) onRunItBack(round);
  };
